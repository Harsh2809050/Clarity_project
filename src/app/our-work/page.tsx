        ...
        <div className="container-editorial">
                ...
                return (
                  <AnimateIn key={issue.id} delay={issueIdx * 0.04}>
                    <article>
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-[1fr_300px] xl:grid-cols-[1fr_320px] gap-12 xl:gap-16">
          ...
          {workIssues.length < 3 && (
            <div className="mt-20 pt-12 border-t border-rim dark:border-rim-dark">
              <p className="font-sans text-[11px] font-semibold uppercase tracking-[0.16em] text-ink-faint dark:text-ink-snow-faint mb-3">Published weekly</p>
              <p className="font-serif text-xl font-bold text-ink dark:text-ink-snow mb-2">More conversations are coming.</p>
